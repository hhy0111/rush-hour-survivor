...
- Confirmed the deployed privacy-policy URL at `https://hhy0111.github.io/rush-hour-survivor/public/privacy-policy.html`.
- Added Google Play short/full description drafts to `docs/release_ops/STORE_PREP.md`.
- TODO for next pass: add real-device Android checks, and finalize monetization values.
