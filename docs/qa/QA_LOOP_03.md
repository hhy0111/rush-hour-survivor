...
- `Major`: privacy policy URL, ad IDs, IAP IDs, and store copy are still missing, so launch prep cannot be closed
...
- Final launch readiness still depends on privacy policy deployment URL, store copy, and live monetization values
